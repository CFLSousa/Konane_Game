...
par_jogos(Lim,Jog1,Jog2,Res1,Res2) :-
       nl,nl,tab(20),write('UM PAR DE JOGOS '),nl,nl,
...
par_jogosVits(Lim,Jog1,Jog2,[Venc1,Venc2]) :-
       nl,nl,tab(20),write('UM PAR DE JOGOS '),nl,nl,
       jogoEsconde(Lim,Jog1,Jog2,Venc1-_,_),nl,write('Vitoria de '),write(Venc1),nl,
       jogoEsconde(Lim,Jog2,Jog1,Venc2-_,_),nl,write('Vitoria de '),write(Venc2),nl.
...
pede_jogada(tab(Cor,N,B,P),Jogada,NovoTab) :-
      repeat,
      pedeJogada,
      read(Jogada),
      jogada(tab(Cor,N,B,P),NovoTab,Jogada).
...
%      jogador(Nome,Quem,_),
%      nl,nl,tab(20),write(Quem),write(': '),write('JOGADOR '),write(Nome),nl,nl.
