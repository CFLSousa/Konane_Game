% qual alfabeta
% Se o jogo eh simetrico podemos ignorar metade das jogadas inaugurais
% pesquisando menos jogadas e acelerando a abertura do jogo.

qual_alpha_beta(Nome,Estado,Lim,MelhorJog,MelhorSuc,Avalia) :-
       alphabeta(Nome,Estado,Lim,-10000,10000,MelhorJog,MelhorSuc,_,jogada,Avalia).
